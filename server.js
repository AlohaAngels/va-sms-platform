...
app.get("/health", (req, res) => {
  ...
  res.json({
    status: "ok",
    service: "Visiting Angels AI SMS Platform (Phase 2)",
...
console.log("⏰ Scheduled: Email queue processing (every 5 min)");
console.log("⏰ Scheduled: Weekly report (Mondays 7am MT)");
